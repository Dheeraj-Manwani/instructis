...
export function Results() {
  ...
  return (
    <section id="results" className="py-24 bg-dark-navy relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-900/20 via-dark-navy to-dark-navy" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          {["2025", "2024", "2023"].map((y) => (
            <button
              ...
              className={cn(
                ...
                year === y 
                  ? "bg-gradient-to-r from-amber-400 to-amber-600 text-dark-navy shadow-[0_0_20px_rgba(245,158,11,0.4)]" 
        ...
        <div className="mt-12 text-center">
          <button className="text-amber-400 font-bold hover:text-amber-300 transition-colors inline-flex items-center gap-2">
            View All Results 2025 <Star className="w-4 h-4 fill-current" />
          </button>
        </div>
      </div>
    </section>
