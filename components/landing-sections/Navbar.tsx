        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Button
              ...
              variant="outline"
              className={cn(
                "h-9 rounded-full border-slate-200 px-3 text-xs font-semibold dark:border-slate-700",
              )}
      ...
      <Dialog open={phoneModalOpen} onOpenChange={setPhoneModalOpen}>
        <DialogContent className="sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              Use the number below to call or copy.
            </DialogDescription>
          </DialogHeader>
          <div className="rounded-md border border-border bg-muted/30 p-3 text-sm font-semibold">
            {supportPhone}
          </div>
